    ...
    <div class="md:flex md:flex-col">
      <div class="md:flex md:flex-col md:h-screen">
        <div class="md:flex md:flex-shrink-0">
          <div class="flex items-center justify-between bg-indigo-900 md:flex-shrink-0 md:justify-center md:w-56">
            <Link class="mt-1" href="/">
              <img class="fill-white" style="width:120px; min-height: 55px;" src="/img/logo.png"  />
            </Link>
            ...
            <dropdown class="mt-1" placement="bottom-end">
              ...
              <template #dropdown>
                <div class="mt-2 py-2 text-sm bg-white rounded shadow-xl">
                  <Link class="block px-6 py-2 hover:text-white hover:bg-indigo-500" :href="`/users/${auth.user.id}/edit`">User Info</Link>
                  <Link class="block px-6 py-2 hover:text-white hover:bg-indigo-500" href="/users">User Manage</Link>
        ...
        <div class="md:flex md:flex-grow md:overflow-hidden">
          <main-menu class="hidden flex-shrink-0 p-8 w-56 bg-indigo-800 overflow-y-auto md:block" />
